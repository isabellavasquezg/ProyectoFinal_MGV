...
--
-- Base de datos: `gestorlimebd`
--

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `api_desactivacionequipo`
--

CREATE TABLE `api_desactivacionequipo` (
...
--
-- Volcado de datos para la tabla `api_desactivacionequipo`
--

INSERT INTO `api_desactivacionequipo` (`id`, `fecha_desactivacion`, `responsable_desactivacion`, `justificacion`, `equipo_id`) VALUES
(3, '2025-12-02', 'admin', 'Daño', 276);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `api_edicionequipo`
--

CREATE TABLE `api_edicionequipo` (
  `id` bigint(20) NOT NULL,
  `fecha` date NOT NULL,
  `justificacion` longtext NOT NULL,
  `equipo_id` bigint(20) NOT NULL,
...
--
-- Volcado de datos para la tabla `api_edicionequipo`
--
...
--
-- Volcado de datos para la tabla `api_equipo`
--
...
--
-- Estructura de tabla para la tabla `api_trasladoequipo`
--

CREATE TABLE `api_trasladoequipo` (
  `id` bigint(20) NOT NULL,
  `fecha_solicitud` date NOT NULL,
  `usuario_solicitante` varchar(100) NOT NULL,
  `sede_origen` varchar(100) DEFAULT NULL,
  `sede_destino` varchar(100) NOT NULL,
  `justificacion` longtext NOT NULL,
  `estado` varchar(20) NOT NULL,
  `fecha_aprobacion` datetime(6) DEFAULT NULL,
  `observaciones_aprobacion` longtext DEFAULT NULL,
  `fecha_ejecucion` datetime(6) DEFAULT NULL,
  `observaciones_ejecucion` longtext DEFAULT NULL,
  `equipo_id` bigint(20) NOT NULL,
  ...
  `rechazado_por` varchar(100) DEFAULT NULL,
  `responsable_destino` varchar(100) DEFAULT NULL,
  `responsable_origen` varchar(100) DEFAULT NULL,
  `ubicacion_destino` longtext DEFAULT NULL,
  `ubicacion_origen` longtext DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `api_trasladoequipo`
--
...
(41, 'Can add traslado equipo', 11, 'add_trasladoequipo'),
(42, 'Can change traslado equipo', 11, 'change_trasladoequipo'),
(43, 'Can delete traslado equipo', 11, 'delete_trasladoequipo'),
(44, 'Can view traslado equipo', 11, 'view_trasladoequipo');
...
--
-- Indices de la tabla `api_desactivacionequipo`
--
ALTER TABLE `api_desactivacionequipo`
  ADD PRIMARY KEY (`id`),
  ADD KEY `api_desactivacionequipo_equipo_id_6a23bc16_fk_api_equipo_id` (`equipo_id`);

--
-- Indices de la tabla `api_edicionequipo`
--
ALTER TABLE `api_edicionequipo`
  ADD PRIMARY KEY (`id`),
  ADD KEY `api_edicionequipo_equipo_id_672f6218_fk_api_equipo_id` (`equipo_id`);
...
--
-- Indices de la tabla `api_trasladoequipo`
--
ALTER TABLE `api_trasladoequipo`
  ADD PRIMARY KEY (`id`),
  ADD KEY `api_trasladoequipo_equipo_id_6c69b17e_fk_api_equipo_id` (`equipo_id`);
...
--
-- AUTO_INCREMENT de la tabla `api_desactivacionequipo`
--
ALTER TABLE `api_desactivacionequipo`
...
--
-- Filtros para la tabla `api_desactivacionequipo`
--
ALTER TABLE `api_desactivacionequipo`
  ADD CONSTRAINT `api_desactivacionequipo_equipo_id_6a23bc16_fk_api_equipo_id` FOREIGN KEY (`equipo_id`) REFERENCES `api_equipo` (`id`);

--
-- Filtros para la tabla `api_edicionequipo`
--
ALTER TABLE `api_edicionequipo`
  ADD CONSTRAINT `api_edicionequipo_equipo_id_672f6218_fk_api_equipo_id` FOREIGN KEY (`equipo_id`) REFERENCES `api_equipo` (`id`);

--
-- Filtros para la tabla `api_trasladoequipo`
--
ALTER TABLE `api_trasladoequipo`
  ADD CONSTRAINT `api_trasladoequipo_equipo_id_6c69b17e_fk_api_equipo_id` FOREIGN KEY (`equipo_id`) REFERENCES `api_equipo` (`id`);
